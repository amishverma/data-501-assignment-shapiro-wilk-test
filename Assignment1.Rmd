...
The function developed in this assignment calculates the test statistic 𝑊,performs necessary input validation, and optionally generates a Q-Q plot to visually assess the normality of the data.
